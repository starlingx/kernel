...
#define NAL_MAX_DRIVER_VERSION_LENGTH 32
#define RETURN 
...
#define NAL_GETDRIVERVERSION_FUNCID 0
...
#define NAL_WIN_ALLOCATEMEMORYNONPAGEDPCI_FUNCID 9
#define NAL_WIN_FREEMEMORYNONPAGEDPCI_FUNCID 10
...
#define NAL_LINUX_IS_IOMMU_ENABLED_FUNCID 15
...
#define NAL_ESXIN_IS_ADAPTER_IN_USE_FUNCID 1
#define NAL_ESXIN_ADAPTER_IN_USE_FUNCID 2
#define NAL_ESXIN_REQUEST_REGIONS_FUNCID 3
#define NAL_ESXIN_RELEASE_REGIONS_FUNCID 4
#define NAL_ESXIN_GET_DRIVER_REFCOUNT_FUNCID 5
#define NAL_ESXIN_DRIVER_GET_VERSION 9
#define NAL_ESXIN_ALLOCATEMEMORYNONPAGEDPCI_FUNCID 10
#define NAL_ESXIN_FREEMEMORYNONPAGEDPCI_FUNCID 11

#define NAL_FREEBSD_IS_ADAPTER_IN_USE_FUNCID 1
#define NAL_FREEBSD_ADAPTER_IN_USE_FUNCID 2
#define NAL_FREEBSD_REQUEST_REGIONS_FUNCID 3
#define NAL_FREEBSD_RELEASE_REGIONS_FUNCID 4
#define NAL_FREEBSD_GET_DRIVER_REFCOUNT_FUNCID 5
#define NAL_FREEBSD_INC_DRIVER_REFCOUNT_FUNCID 6
#define NAL_FREEBSD_DEC_DRIVER_REFCOUNT_FUNCID 7
#define NAL_FREEBSD_FILL_DEVICE_RESOURCE_FUNCID 8
#define NAL_FREEBSD_DRIVER_GET_VERSION 9
#define NAL_FREEBSD_ALLOCATEMEMORYNONPAGEDPCI_FUNCID 10
#define NAL_FREEBSD_FREEMEMORYNONPAGEDPCI_FUNCID 11

typedef struct _NAL_QV_DRV_VER
{
    UINT8 Major;
    UINT8 Minor;
    UINT8 Build;
...
NAL_STATUS
_NalGetDriverVersion(
    OUT NAL_QV_DRV_VER* QvDriverVersion
    );
...
typedef struct _NAL_ADAPTER_IN_USE_FUNC
{
  ...
  NAL_ESXIN_ADAPTER_IN_USE_FUNC,
  NAL_SOLARIS_ADAPTER_IN_USE_FUNC ,
  NAL_FREEBSD_ADAPTER_IN_USE_FUNC;
...
typedef struct _NAL_IS_ADAPTER_IN_USE_FUNC
{
  ...
  NAL_ESXIN_IS_ADAPTER_IN_USE_FUNC,
  NAL_SOLARIS_IS_ADAPTER_IN_USE_FUNC ,
  NAL_FREEBSD_IS_ADAPTER_IN_USE_FUNC;
...
typedef struct _NAL_LINUX_DEVICERESOURCE_FUNCS
{
  ...
  NAL_ESXIN_DEVICERESOURCE_FUNC,
  NAL_SOLARIS_DEVICERESOURCE_FUNC,
  NAL_FREEBSD_DEVICERESOURCE_FUNC;
...
typedef struct _NAL_LINUX_REFCOUNT_FUNCS
{
  ...
  NAL_ESXIN_REFCOUNT_FUNCS,
  NAL_FREEBSD_REFCOUNT_FUNCS,
  NAL_SOLARIS_REFCOUNT_FUNCS;

typedef struct _NAL_LINUX_DRIVER_GET_VERSION_FUNCS
{
    OUT CHAR Version[NAL_MAX_DRIVER_VERSION_LENGTH];
} NAL_LINUX_DRIVER_GET_VERSION_FUNCS,
  NAL_ESXI_DRIVER_GET_VERSION_FUNCS,
  NAL_ESXIN_DRIVER_GET_VERSION_FUNCS,
  NAL_FREEBSD_DRIVER_GET_VERSION_FUNCS,
...
typedef struct _NAL_GETDRIVERVERSION_FUNC
{
    RETURN NAL_STATUS ReturnValue;
    OUT NAL_QV_DRV_VER QvDriverVersion;
} NAL_GETDRIVERVERSION_FUNC;
...
typedef struct _NAL_WIN_ALLOCATEMEMORYNONPAGEDPCI_FUNC
{
    RETURN KVOID* ReturnValue;
    IN NAL_DEVICE_LOCATION PciLocation;
    IN UINT32 ByteCount;
    IN UINT32 Alignment;
    OUT NAL_PHYSICAL_ADDRESS PhysicalAddress;
} NAL_WIN_ALLOCATEMEMORYNONPAGEDPCI_FUNC;

typedef struct _NAL_WIN_FREEMEMORYNONPAGEDPCI_FUNC
{
    IN KVOID* Address;
} NAL_WIN_FREEMEMORYNONPAGEDPCI_FUNC;
...
typedef struct _NAL_LINUX_ALLOCATEMEMORYNONPAGEDPCI_FUNC
{
    ...
    NAL_ESXIN_ALLOCATEMEMORYNONPAGEDPCI_FUNC,
    NAL_FREEBSD_ALLOCATEMEMORYNONPAGEDPCI_FUNC,
...
typedef struct _NAL_LINUX_FREEMEMORYNONPAGEDPCI_FUNC
{
    ...
    NAL_ESXIN_FREEMEMORYNONPAGEDPCI_FUNC,
    NAL_SOLARIS_FREEMEMORYNONPAGEDPCI_FUNC;

typedef struct _NAL_FREEBSD_FREEMEMORYNONPAGEDPCI_FUNC
{
    IN KVOID* PDev;
    IN KVOID* Address;
} NAL_FREEBSD_FREEMEMORYNONPAGEDPCI_FUNC;
...
typedef struct _NAL_READPCIDEVICE_FUNC
{
    RETURN NAL_STATUS ReturnValue;
    IN UINT16 Count;
    OUT NAL_DEVICE_LOCATION PciLocations[255];
...
typedef struct _NAL_LINUX_IS_IOMMU_ENABLED_FUNC
{
    RETURN NAL_IOMMU_STATE ReturnValue;
} NAL_LINUX_IS_IOMMU_ENABLED_FUNC;

typedef union _NAL_IOCTL_FUNCTION_DATA
{

    NAL_GETDRIVERVERSION_FUNC NalGetDriverVersionFunc;
    ...
    NAL_WIN_ALLOCATEMEMORYNONPAGEDPCI_FUNC NalWinAllocateMemoryNonPagedPciFunc;
    NAL_WIN_FREEMEMORYNONPAGEDPCI_FUNC NalWinFreeMemoryNonPagedPciFunc;
#endif
    ...
    NAL_LINUX_IS_IOMMU_ENABLED_FUNC NalLinuxIsIommuEnabledFunc;
#endif
    ...
    NAL_SOLARIS_DEVICERESOURCE_FUNC NalSolarisDeviceResourceFunc;
    ...
    NAL_ESXIN_ADAPTER_IN_USE_FUNC NalEsxinAdapterInUseFunc;
    NAL_ESXIN_IS_ADAPTER_IN_USE_FUNC NalEsxinIsAdapterInUseFunc;
    NAL_ESXIN_DEVICERESOURCE_FUNC NalEsxinDeviceResourceFunc;
    NAL_ESXIN_REFCOUNT_FUNCS NalEsxinReferenceCountFuncs;
    NAL_ESXIN_DRIVER_GET_VERSION_FUNCS NalEsxinDriverGetVersionFuncs;
    NAL_ESXIN_ALLOCATEMEMORYNONPAGEDPCI_FUNC NalEsxinAllocateMemoryNonPagedPciFunc;
    NAL_ESXIN_FREEMEMORYNONPAGEDPCI_FUNC NalEsxinFreeMemoryNonPagedPciFunc;

#endif

#if defined(NAL_FREEBSD)

    NAL_FREEBSD_ADAPTER_IN_USE_FUNC NalFreebsdAdapterInUseFunc;
    NAL_FREEBSD_IS_ADAPTER_IN_USE_FUNC NalFreebsdIsAdapterInUseFunc;
    NAL_FREEBSD_DRIVER_GET_VERSION_FUNCS NalFreebsdDriverGetVersionFuncs;
    NAL_FREEBSD_ALLOCATEMEMORYNONPAGEDPCI_FUNC NalFreebsdAllocateMemoryNonPagedPciFunc;
    NAL_FREEBSD_FREEMEMORYNONPAGEDPCI_FUNC NalFreebsdFreeMemoryNonPagedPciFunc;
    NAL_FREEBSD_DEVICERESOURCE_FUNC NalFreebsdDeviceResourceFunc;
    NAL_FREEBSD_REFCOUNT_FUNCS NalFreebsdReferenceCountFuncs;
#endif
