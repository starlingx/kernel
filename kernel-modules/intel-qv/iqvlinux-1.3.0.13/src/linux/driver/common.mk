...
warn_signed_modules :=
ifeq (${SIG_KEY_FILE},)
  # Print nothing if DISABLE_MODULE_SIGNING is already set
  ifeq (${DISABLE_MODULE_SIGNING},)
...
$(if $(shell \
    ...
    KSRC=${KSRC} OUT=../../../inc/linux/kcompat_generated_defs.h CONFFILE=${CONFIG_FILE} \
